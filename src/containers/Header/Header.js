    ...
    <div className="Headercontainer">
      <NavBar id="navbar">
        <span className="header">
          <Col>
           <Link to={ROUTES.HOME} className="header-link" id="headerLogo">
            ...
            <div className="linkPosition" >
              ...
              <Link to={ROUTES.CARTDETAILS} className="header-link cartIcon">
                <FaShoppingCart  className="cart-icon"/>
                <Badge variant="primary" className="cartBadge">
